...
export default function CalculatorCTA() {
  return (
    <section className="lg:pt-28 pt-12 pb-0 relative overflow-visible z-10 -mb-20 lg:-mb-28">
      ...
      <div className="container relative overflow-visible z-10">
        {/* Floating Green Card */}
        <div className="bg-accent rounded-[20px] lg:rounded-[28px] px-8 py-10 md:px-12 md:py-14 xl:px-16 xl:py-16 relative overflow-hidden shadow-2xl z-10 min-h-[320px] lg:min-h-[420px] xl:min-h-[500px] flex flex-col justify-between items-start">
          {/* Grid pattern */}
          <div
          ...
          <h1 className="type-h1 text-left flex flex-col items-start gap-1 md:gap-1 leading-[1] relative z-10 -ml-2">
            <span className="sr-only">Számold ki Online</span>
            <div className="flex flex-col items-start gap-2 md:gap-2" aria-hidden="true">
